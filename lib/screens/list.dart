...
class _TodoScreenState extends State<TodoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final weekDaysName =
        weekDates.map((date) => DateFormat('E').format(date)).toList();
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                              width: 16.0), // Add some spacing between buttons
                          FloatingActionButton(
                            mini: true,
                            onPressed: () {
                              downloadTaskList();
                          ...
                          onChanged: (bool? newValue) {
                            setState(() {
                              task['isDone'] = newValue ??
                                  false; // Update the 'isDone' property based on the new value
                            });
                          },
                        ),
                        title: Text(
    ...
    pdfLib.Page(
      ...
      build: (context) {
        return pdfLib.Center(
          child: pdfLib.Text('Your task list goes here.'),
        );
      },
    ),
  );
  ...
  void savePdf(pdfLib.Document pdf) {
    // Save the PDF to a file (you'll need proper permissions to save files)
    // For simplicity, we'll print a message indicating the file path.
    final filePath = '/path/to/your/task_list.pdf';
